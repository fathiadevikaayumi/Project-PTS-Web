...
// Judul hasil
echo "<h2>Hasil Jawaban - Fisika</h2>";
...
if (isset($_POST['pg1']) && $_POST['pg1'] == "b") {
    ...
    echo "<p>1. Salah ❌ (Jawaban benar: b. benda bergetar)</p>";
}
...
if (isset($_POST['pg2']) && $_POST['pg2'] == "b") {
    ...
    echo "<p>2. Salah ❌ (Jawaban benar: b. suara ambulans yang berubah saat mendekat dan menjauh)</p>";
}
...
if (!empty($_POST['esai'])) {
    ...
    if (strpos($jawaban, 'ikut bergetar') !== false) {
        echo "<p>3. Benar ✅</p>";
        $skor += $bobot['esai'];
    } else {
        echo "<p>3. Salah ❌ (Resonansi adalah peristiwa ikut bergetarnya suatu benda karena ada getaran dari luar dengan frekuensi yang sama.)</p>";
    }
} else {
...
// -----------------------------
$nama  = $_POST['nama'];   // dari form tugas fisika
$mapel = "Fisika";
